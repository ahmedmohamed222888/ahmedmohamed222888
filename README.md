...
<details>
<summary><strong>🎧 أثناء الكود... أستمع إلى:</strong></summary>
...
class AhmedAbdelSalam {
    val languages = listOf("Kotlin", "Java", "Dart", "C++", "Python", "HTML", "CSS")
    val databases = listOf("Firebase", "SQLite")
    val tools = listOf("Android Studio", "Qt Creator", "Intellij", "Net Beans",  "Git", "Figma", "Photoshop")
}
